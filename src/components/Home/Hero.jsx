        ...
        <section ref={mainRef} className={styles.heroAnimeStart}>
            <div className={`${styles.headingsWraper} relative h-screen`}>
                ...
                <h2 className="text-white font-extralight uppercase text-center -mt-6">
                    OF <span className={`${styles.mainTitleGradient} font-medium`}>SAUDI</span>
                </h2>
                ...
                <div ref={heroBtnFloat} className="relative w-[100%] text-center mt-10 flex items-center justify-between opacity-0 translate-y-5 heroBtnFloat">
                    <Link className="whiteToGreen m-auto" href='/'>Contact Us
